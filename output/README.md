...
## ⚙️ [run #2236](https://github.com/jwenerd/ytm-dl/actions/runs/10877149064)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |15648|1.5M|
...
|[`output/library_subscriptions.csv` ](output/library_subscriptions.csv)  |115  |8.0K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1843 |156K|