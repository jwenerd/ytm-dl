...
## ⚙️ [run #1182](https://github.com/jwenerd/ytm-dl/actions/runs/9039111722)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |8609 |816K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1707 |144K|