...
## ⚙️ [run #3441](https://github.com/jwenerd/ytm-dl/actions/runs/13259769779)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |22202|2.1M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |6814 |576K|
