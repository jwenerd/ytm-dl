...
## ⚙️ [run #805](https://github.com/jwenerd/ytm-dl/actions/runs/8461342726)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |6003 |568K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1621 |140K|