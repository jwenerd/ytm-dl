...
## ⚙️ [run #739](https://github.com/jwenerd/ytm-dl/actions/runs/8368297575)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |5433 |516K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |4009 |336K|
