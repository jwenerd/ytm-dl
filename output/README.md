...
## ⚙️ [run #1509](https://github.com/jwenerd/ytm-dl/actions/runs/9584680811)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |10370|984K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |5796 |488K|
