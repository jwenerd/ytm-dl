...
## ⚙️ [run #1956](https://github.com/jwenerd/ytm-dl/actions/runs/10357460115)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |13577|1.3M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |5959 |500K|
