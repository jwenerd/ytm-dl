...
## ⚙️ [run #2089](https://github.com/jwenerd/ytm-dl/actions/runs/10602470363)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |15064|1.4M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1829 |156K|