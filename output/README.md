...
## ⚙️ [run #1812](https://github.com/jwenerd/ytm-dl/actions/runs/10104268272)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |12378|1.2M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1781 |152K|