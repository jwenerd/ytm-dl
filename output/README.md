...
## ⚙️ [run #4122](https://github.com/jwenerd/ytm-dl/actions/runs/14814762159)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |26427|2.5M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |7871 |692K|
