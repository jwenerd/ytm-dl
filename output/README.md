...
## ⚙️ [run #1744](https://github.com/jwenerd/ytm-dl/actions/runs/9979629303)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |11622|1.1M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |5853 |492K|
