...
## ⚙️ [run #3477](https://github.com/jwenerd/ytm-dl/actions/runs/13340622631)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |22562|2.1M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |6839 |576K|
