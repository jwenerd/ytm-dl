...
## ⚙️ [run #4282](https://github.com/jwenerd/ytm-dl/actions/runs/15217030247)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |27733|2.7M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |8004 |708K|
