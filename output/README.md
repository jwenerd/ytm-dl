...
## ⚙️ [run #695](https://github.com/jwenerd/ytm-dl/actions/runs/8309702326)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |5171 |488K|
|[`output/library_albums.csv` ](output/library_albums.csv)                |997  |68K |
|[`output/library_artists.csv` ](output/library_artists.csv)              |2208 |96K |
|[`output/library_songs.csv` ](output/library_songs.csv)                  |3973 |332K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1581 |136K|