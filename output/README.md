...
## ⚙️ [run #1611](https://github.com/jwenerd/ytm-dl/actions/runs/9756154823)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |10922|1.1M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1770 |152K|