...
## ⚙️ [run #442](https://github.com/jwenerd/ytm-dl/actions/runs/7980214055)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |3129 |296K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |3674 |304K|
