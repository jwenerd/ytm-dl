...
## ⚙️ [run #4772](https://github.com/jwenerd/ytm-dl/actions/runs/16479231388)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |30679|2.9M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |4557 |384K|