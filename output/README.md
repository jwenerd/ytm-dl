...
## ⚙️ [run #1041](https://github.com/jwenerd/ytm-dl/actions/runs/8828044664)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |7913 |744K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1688 |144K|