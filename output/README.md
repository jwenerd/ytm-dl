...
## ⚙️ [run #2349](https://github.com/jwenerd/ytm-dl/actions/runs/11100790942)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |16339|1.6M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |4254 |360K|