...
## ⚙️ [run #4388](https://github.com/jwenerd/ytm-dl/actions/runs/15474684512)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |28588|2.7M|
|[`output/home.csv` ](output/home.csv)                                    |4172 |380K|
|[`output/library_albums.csv` ](output/library_albums.csv)                |1178 |80K |
|[`output/library_artists.csv` ](output/library_artists.csv)              |2644 |116K|
|[`output/library_songs.csv` ](output/library_songs.csv)                  |8096 |712K|
