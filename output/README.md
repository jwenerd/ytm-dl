...
## ⚙️ [run #2332](https://github.com/jwenerd/ytm-dl/actions/runs/11080757235)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |16282|1.6M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |3053 |260K|