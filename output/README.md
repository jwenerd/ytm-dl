...
## ⚙️ [run #2432](https://github.com/jwenerd/ytm-dl/actions/runs/11267530200)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |17493|1.7M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |4297 |360K|