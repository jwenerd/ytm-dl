...
## ⚙️ [run #2910](https://github.com/jwenerd/ytm-dl/actions/runs/12215233495)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |19850|1.9M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |6508 |548K|
