...
## ⚙️ [run #4632](https://github.com/jwenerd/ytm-dl/actions/runs/16096286674)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |30075|2.9M|
...
|[`output/library_upload_albums.csv` ](output/library_upload_albums.csv)  |1357 |200K|
|[`output/library_upload_artists.csv` ](output/library_upload_artists.csv)|1832 |200K|
|[`output/library_upload_songs.csv` ](output/library_upload_songs.csv)    |18280|1.4M|
