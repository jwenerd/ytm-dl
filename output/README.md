...
## ⚙️ [run #593](https://github.com/jwenerd/ytm-dl/actions/runs/8161226122)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |4560 |432K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |3941 |328K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1567 |136K|