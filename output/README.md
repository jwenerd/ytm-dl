...
## ⚙️ [run #4144](https://github.com/jwenerd/ytm-dl/actions/runs/14863882849)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |26494|2.5M|
|[`output/home.csv` ](output/home.csv)                                    |4172 |380K|
|[`output/library_albums.csv` ](output/library_albums.csv)                |1163 |80K |
|[`output/library_artists.csv` ](output/library_artists.csv)              |2571 |112K|
|[`output/library_songs.csv` ](output/library_songs.csv)                  |7886 |692K|
