...
## ⚙️ [run #572](https://github.com/jwenerd/ytm-dl/actions/runs/8145219399)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |4441 |424K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |3908 |324K|
