...
## ⚙️ [run #4966](https://github.com/jwenerd/ytm-dl/actions/runs/17015674850)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |31259|3.0M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |8353 |736K|
