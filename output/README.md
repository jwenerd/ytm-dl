...
## ⚙️ [run #4186](https://github.com/jwenerd/ytm-dl/actions/runs/14959881309)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |26763|2.5M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |7909 |696K|
