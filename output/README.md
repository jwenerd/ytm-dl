...
## ⚙️ [run #1230](https://github.com/jwenerd/ytm-dl/actions/runs/9115043131)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |8903 |844K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1713 |144K|