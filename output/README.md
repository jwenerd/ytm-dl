...
## ⚙️ [run #1377](https://github.com/jwenerd/ytm-dl/actions/runs/9343847110)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |9523 |904K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |5735 |484K|
