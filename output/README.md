...
## ⚙️ [run #804](https://github.com/jwenerd/ytm-dl/actions/runs/8461241640)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |5999 |568K|
|[`output/library_albums.csv` ](output/library_albums.csv)                |1008 |68K |
|[`output/library_artists.csv` ](output/library_artists.csv)              |2226 |100K|
|[`output/library_songs.csv` ](output/library_songs.csv)                  |4153 |348K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1619 |140K|