...
## ⚙️ [run #2246](https://github.com/jwenerd/ytm-dl/actions/runs/10900345403)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |15870|1.5M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1845 |156K|