...
## ⚙️ [run #3353](https://github.com/jwenerd/ytm-dl/actions/runs/13081077162)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |21697|2.1M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |6746 |568K|
