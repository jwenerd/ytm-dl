...
## ⚙️ [run #3361](https://github.com/jwenerd/ytm-dl/actions/runs/13092608503)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |21708|2.1M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |4388 |368K|