...
## ⚙️ [run #1275](https://github.com/jwenerd/ytm-dl/actions/runs/9179653714)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |9086 |860K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1716 |148K|