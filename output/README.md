...
## ⚙️ [run #3831](https://github.com/jwenerd/ytm-dl/actions/runs/14141851520)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |24456|2.3M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |7672 |676K|
