...
## ⚙️ [run #803](https://github.com/jwenerd/ytm-dl/actions/runs/8461064901)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |5998 |568K|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |4152 |344K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1618 |140K|