...
## ⚙️ [run #2159](https://github.com/jwenerd/ytm-dl/actions/runs/10738689907)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |15439|1.5M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |6077 |512K|
