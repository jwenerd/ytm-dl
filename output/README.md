...
## ⚙️ [run #2912](https://github.com/jwenerd/ytm-dl/actions/runs/12218022213)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |19872|1.9M|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |4345 |364K|