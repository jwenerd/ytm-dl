...
## ⚙️ [run #1103](https://github.com/jwenerd/ytm-dl/actions/runs/8932876466)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |8341 |788K|
...
|[`output/liked_songs.csv` ](output/liked_songs.csv)                      |1697 |144K|