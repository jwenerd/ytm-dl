...
## ⚙️ [run #4773](https://github.com/jwenerd/ytm-dl/actions/runs/16482343529)

### 📁 Files

|                                                                         |lines|size|
|-------------------------------------------------------------------------|-----|----|
|[`output/history.csv` ](output/history.csv)                              |30680|2.9M|
...
|[`output/library_songs.csv` ](output/library_songs.csv)                  |8280 |728K|
